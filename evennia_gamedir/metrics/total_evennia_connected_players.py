...
def create_total_evennia_connected_players_metric():
    client = get_metrics_client()

    # This is our specific metric name
    custom_metric_type = "custom.googleapis.com/evennia/total-connected-players"
    ...
    metrics_descriptor = {
        ...
        "displayName": "Total Connected Players"
    }
...
def write_total_evennia_connected_players_metric(player_count):
    client = get_metrics_client()
    project_resource = "projects/{0}".format(GCP_PROJECT_ID)
    custom_metric_type = "custom.googleapis.com/evennia/total-connected-players"
